...
package com.mrz07.gdxdialogs.core.dialogs;
...
public interface GDXProgressDialog {
	...
	/**
	 * When set true, the user can dismiss the dialog by tapping outside of it
	 * or pressing the back button. Default is false.
	 * Has no effect on platforms that do not support it (HTML).
	 *
	 * @param cancelable whether the dialog can be dismissed by the user
	 * @return The same instance that the method was called from.
	 */
	GDXProgressDialog setCancelable(boolean cancelable);
