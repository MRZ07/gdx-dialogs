...
public class GDXDialogsSystem {
	...
	private void installDesktopGDXDialogs() {
		...
		try {
			...
			final Class<?> dialogManagerClazz = ClassReflection.forName("com.mrz07.gdxdialogs.desktop.DesktopGDXDialogs");
	...
	private void installHTMLGDXDialogs() {
		...
		try {
			...
			final Class<?> dialogManagerClazz = ClassReflection.forName("com.mrz07.gdxdialogs.html.HTMLGDXDialogs");
			Object dialogManager = ClassReflection.getConstructor(dialogManagerClazz).newInstance();
	...
	private void installIOSGDXDialogs() {
		...
		try {
			...
			final Class<?> dialogManagerClazz = ClassReflection.forName("com.mrz07.gdxdialogs.ios.IOSGDXDialogs");
			...
			try {
				final Class<?> dialogManagerClazz = ClassReflection.forName("com.mrz07.gdxdialogs.iosmoe.IOSMOEGDXDialogs");
	...
	private void installAndroidGDXDialogs() {
		...
		if (Gdx.app.getType() == ApplicationType.Android) {
			try {
				...
				Class<?> dialogManagerClazz = ClassReflection.forName("com.mrz07.gdxdialogs.android.AndroidGDXDialogs");
	...
	private void showErrorInstall(String os, String artifact) {
		...
		Gdx.app.error(GDXDialogsVars.LOG_TAG, "Did you add compile >> \"com.mrz07.gdxdialogs:gdx-dialogs-" + artifact + ":" + GDXDialogsVars.VERSION
